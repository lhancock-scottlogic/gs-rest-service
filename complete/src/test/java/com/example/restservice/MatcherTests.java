...
public class MatcherTests {
    ArrayList<UserOrder> buyArray = new ArrayList<UserOrder>();
    ArrayList<UserOrder> sellArray = new ArrayList<UserOrder>();
    ...
    */
    ...
    void SortPriceHighToLowTest() {
        ArrayList<UserOrder> testList = new ArrayList<UserOrder>();
        UserOrder testOrder1 = new UserOrder(0, "Account_1", 50.63, 100, "buy", now);
        UserOrder testOrder2 = new UserOrder(1, "Account_2", 182.99, 999, "buy", now);
        UserOrder testOrder3 = new UserOrder(2, "Account_3", 50.64, 17, "buy", now);
    ...
    void SortDateHighToLowTest() {
        ArrayList<UserOrder> testList = new ArrayList<>();
        UserOrder testOrder1 = new UserOrder(0, "Account_1", 50.63, 100, "buy", LocalDateTime.of(2019, 3, 28, 14, 33));
        UserOrder testOrder2 = new UserOrder(1, "Account_2", 182.99, 999, "buy", LocalDateTime.of(2019, 3, 28, 14, 34));
        UserOrder testOrder3 = new UserOrder(2, "Account_3", 50.64, 17, "buy", now);
        testList.add(testOrder1);
        testList.add(testOrder2);
        testList.add(testOrder3);
    ...
    void RemoveOrderTest() {
        ...
        ArrayList<UserOrder> testBuyOrders = new ArrayList<UserOrder>();
        testBuyOrders.add(new UserOrder(0, "Account_1", 50.63, 100, "buy", now));
        testBuyOrders.add(new UserOrder(2, "Account_3", 182.99, 999, "buy", now));
        matcher.buyList.add(new UserOrder(0, "Account_1", 50.63, 100, "buy", now));
        matcher.buyList.add(new UserOrder(1, "Account_2", 77.09, 75, "buy", now));
        matcher.buyList.add(new UserOrder(2, "Account_3", 182.99, 999, "buy", now));
        ...
        ArrayList<UserOrder> testSellOrders = new ArrayList<UserOrder>();
        testSellOrders.add(new UserOrder(0, "Account_1", 50.63, 100, "sell", now));
        testSellOrders.add(new UserOrder(2, "Account_3", 182.99, 999, "sell", now));
        matcher.sellList.add(new UserOrder(0, "Account_1", 50.63, 100, "sell", now));
        matcher.sellList.add(new UserOrder(1, "Account_2", 77.09, 75, "sell", now));
        matcher.sellList.add(new UserOrder(2, "Account_3", 182.99, 999, "sell", now));
        ...
        testBuyOrders.add(new UserOrder(1, "Account_2", 77.09, 75, "buy", now));
        testSellOrders.add(new UserOrder(1, "Account_2", 77.09, 75, "sell", now));
    ...
    void SearchSellListTest() {
        ...
        UserOrder testOrder1 = new UserOrder(0, "Account_1", 70, 10, "sell", now);
        UserOrder testOrder2 = new UserOrder(1, "Account_2", 95, 15, "sell", now);
        UserOrder testOrder3 = new UserOrder(2, "Account_3", 95, 15, "sell", now);
        UserOrder testOrder4 = new UserOrder(2, "Account_4", 100, 10, "sell", now);
        UserOrder testOrder5 = new UserOrder(2, "Account_5", 90, 10, "sell", now);
        ...
        ArrayList<Trade> searchResult = matcher.searchSellList(new UserOrder(5,"Account_6", 95, 30, "buy", now));
    ...
    void SearchBuyListTest() {
        ...
        UserOrder testOrder1 = new UserOrder(0, "Account_1", 70, 10, "buy", now);
        UserOrder testOrder2 = new UserOrder(1, "Account_2", 95, 15, "buy", now);
        UserOrder testOrder3 = new UserOrder(2, "Account_3", 95, 15, "buy", now);
        UserOrder testOrder4 = new UserOrder(2, "Account_4", 100, 10, "buy", now);
        UserOrder testOrder5 = new UserOrder(2, "Account_5", 90, 10, "buy", now);
        matcher.addOrder(testOrder1);
        matcher.addOrder(testOrder2);
        matcher.addOrder(testOrder3);
        matcher.addOrder(testOrder4);
        matcher.addOrder(testOrder5);
        ArrayList<Trade> searchResult = matcher.searchBuyList(new UserOrder(5,"Account_6", 95, 30, "sell", now));
        ArrayList<Trade> expectedResult = new ArrayList<>();
    ...
    void AddOrder() {
        ArrayList<Trade> testOrder1 = matcher.addOrder(new UserOrder(0, "buyer", 50, 1, "buy", now));
        ArrayList<Trade>  testOrder2 = matcher.addOrder(new UserOrder(1, "seller", 60, 1, "sell", now));
        ArrayList<Trade>  testOrder3 = matcher.addOrder(new UserOrder(2, "buyer", 60, 1, "buy", now));
        ArrayList<Trade>  testOrder4 = matcher.addOrder(new UserOrder(2, "seller", 50, 1, "sell", now));
    ...
    void HasPriceTest() {
        UserOrder testOrder1 = new UserOrder(0, "Account_1", 50.63, 100, "buy", now);
        UserOrder testOrder2 = new UserOrder(1, "Account_2", 77.09, 75, "buy", now);
        UserOrder testOrder3 = new UserOrder(2, "Account_3", 182.99, 999, "sell", now);
        ArrayList<UserOrder> testOrders = new ArrayList<UserOrder>();
    ...
    void GetAggBuysTest() {
        ...
        UserOrder testOrder1 = new UserOrder(0, "Account", 50, 10, "buy", now);
        UserOrder testOrder2 = new UserOrder(1, "Account", 50, 10, "buy", now);
        UserOrder testOrder3 = new UserOrder(2, "Account", 25, 10, "buy", now);
    ...
    void GetAggSellsTest() {
        ...
        UserOrder testOrder1 = new UserOrder(0, "Account", 50, 10, "sell", now);
        UserOrder testOrder2 = new UserOrder(1, "Account", 50, 10, "sell", now);
        UserOrder testOrder3 = new UserOrder(2, "Account", 25, 10, "sell", now);
    ...
    void AggOrderBookTest() throws Exception {
        UserOrder testOrder1 = new UserOrder(0, "Account_1", 50.5, 100, "buy", now);
        UserOrder testOrder2 = new UserOrder(1, "Account_2", 50.42, 75, "buy", now);
        UserOrder testOrder3 = new UserOrder(2, "Account_3", 50.99, 999, "sell", now);
        matcher.buyList.add(testOrder1);
        matcher.buyList.add(testOrder2);
        matcher.sellList.add(new UserOrder(0, "Account", 90.01, 11, "sell", now));
        for(int i = 0; i < 5; i++) {
        ...
        assertThat(matcher.aggOrderBook("buy", 10, 0.1).get(0)).usingRecursiveComparison().isEqualTo(new UserOrder(0, "Account_1", 50.5, 100, "buy", now));
        assertThat(matcher.aggOrderBook("buy", 10, 0.1).get(1)).usingRecursiveComparison().isEqualTo(new UserOrder(1, "Account_2", 50.4, 75, "buy", now));
        ...
        for (int i = 0; i < 4; i++) {
            assertThat(matcher.aggOrderBook("sell", 5, 10).get(i)).usingRecursiveComparison().isEqualTo(new UserOrder(2, "Account_3", 50, 999, "sell", now));
        }
        ...
        assertThat(matcher.aggOrderBook("sell", -1, 10).get(5)).usingRecursiveComparison().isEqualTo(new UserOrder(0, "Account", 90, 11, "sell", now));
    }
