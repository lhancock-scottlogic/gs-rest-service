...
public class MatcherIntegrationTests {
    ...
    void GetAggregatedOrdersTest() {
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 51.21, 250, "buy", LocalDateTime.now()));
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 151.21, 250, "sell", LocalDateTime.now()));
        ...
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/api/v1/matcher/getAggOrderBook?action=buy&numOfOrders=5&pricePoint=10",
                String.class)).contains("[{\"accountId\":0,\"username\":\"Lucy\",\"price\":50.0,\"quantity\":250,\"action\":\"buy\",\"orderDate\":");
        ...
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/api/v1/matcher/getAggOrderBook?action=sell&numOfOrders=-1&pricePoint=5",
                String.class)).contains("[{\"accountId\":0,\"username\":\"Lucy\",\"price\":150.0,\"quantity\":250,\"action\":\"sell\",\"orderDate\":");
        ...
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/api/v1/matcher/getAggOrderBook?action=sell&numOfOrders=10&pricePoint=1.00",
                String.class)).contains("[{\"accountId\":0,\"username\":\"Lucy\",\"price\":151.0,\"quantity\":250,\"action\":\"sell\",\"orderDate\":");
        ...
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/api/v1/matcher/getAggOrderBook?action=sell&numOfOrders=10&pricePoint=0.10",
                String.class)).contains("[{\"accountId\":0,\"username\":\"Lucy\",\"price\":151.2,\"quantity\":250,\"action\":\"sell\",\"orderDate\":");
        ...
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/api/v1/matcher/getAggOrderBook?action=sell&numOfOrders=10&pricePoint=0.01",
                String.class)).contains("[{\"accountId\":0,\"username\":\"Lucy\",\"price\":151.21,\"quantity\":250,\"action\":\"sell\",\"orderDate\":");
    }
    ...
    void GetAllTradesTest() {
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 51.21, 250, "buy", LocalDateTime.now()));
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 51.21, 250, "sell", LocalDateTime.now()));
    ...
    void ViewAggBuysTest() {
        for (int i = 0; i < 5; i++) {
            this.controller.addOrderAPI(new UserOrder(0, "Lucy", 51.21, 10, "buy", LocalDateTime.now()));
        }
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 151.99, 250, "buy", LocalDateTime.now()));
    ...
    void ViewAggSellsTest() {
        for (int i = 0; i < 5; i++) {
            this.controller.addOrderAPI(new UserOrder(0, "Lucy", 51.21, 10, "sell", LocalDateTime.now()));
        }
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 151.99, 250, "sell", LocalDateTime.now()));
    ...
    void ViewPrivateOrdersTest() {
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 1, 1, "sell", LocalDateTime.now()));
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 2.5, 250, "sell", LocalDateTime.now()));
        this.controller.addOrderAPI(new UserOrder(0, "Lucy", 33, 333, "sell", LocalDateTime.now()));
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/api/v1/matcher/getSpecificUserOrders?username=Lucy",
                String.class)).contains("{\"accountId\":0,\"username\":\"Lucy\",\"price\":1.0,\"quantity\":1,\"action\":\"sell\",\"orderDate\":");
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/api/v1/matcher/getSpecificUserOrders?username=Lucy",
                String.class)).contains("{\"accountId\":0,\"username\":\"Lucy\",\"price\":2.5,\"quantity\":250,\"action\":\"sell\",\"orderDate\":");
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/api/v1/matcher/getSpecificUserOrders?username=Lucy",
                String.class)).contains("{\"accountId\":0,\"username\":\"Lucy\",\"price\":33.0,\"quantity\":333,\"action\":\"sell\",\"orderDate\":");
    }
    ...
    void ValidateOrdersTest() {
        List<UserOrder> badOrderList = new ArrayList<>();
        // No null fields cannot be tested since IDE detects incorrect typing before runtime
        // accountId > 0
        badOrderList.add(new UserOrder(-1, "Lucy", 1, 1, "buy", LocalDateTime.now()));
        // username is between 2 and 30 characters
        badOrderList.add(new UserOrder(0, "L", 1, 1, "buy", LocalDateTime.now()));
        badOrderList.add(new UserOrder(0, "Lucyyyyyyyyyyyyyyyyyyyyyyyyyyyy", 1, 1, "buy", LocalDateTime.now()));
        // price is >= £0.01
        badOrderList.add(new UserOrder(0, "Lucy", 0, 1, "buy", LocalDateTime.now()));
        badOrderList.add(new UserOrder(0, "Lucy", -1, 1, "buy", LocalDateTime.now()));
        badOrderList.add(new UserOrder(0, "Lucy", 0.000000001, 1, "buy", LocalDateTime.now()));
        // quantity is >= 1
        badOrderList.add(new UserOrder(0, "Lucy", 1, 0, "buy", LocalDateTime.now()));
        badOrderList.add(new UserOrder(0, "Lucy", 1, -1, "buy", LocalDateTime.now()));
        // orderDate is in the past
        badOrderList.add(new UserOrder(0, "Lucy", 1, 1, "buy", LocalDateTime.parse("2100-03-29T13:34:00.000")));
        // Check each order one by one and assert each one causes a violation
        for (UserOrder badOrder : badOrderList) {
            Set<ConstraintViolation<UserOrder>> violations = validator.validate(badOrder);
